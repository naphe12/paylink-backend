...
print("🧠 Génération intelligente des schémas Pydantic avec relations et imports...")
...
for file in os.listdir(MODELS_DIR):
    ...
    for name, cls in inspect.getmembers(module, inspect.isclass):
        ...
        for rel_name, rel_prop in cls.__mapper__.relationships.items():
            ...
            schema_file = target.lower()
            rel_imports.add(f"from .{schema_file} import {target}Read")
...
print("\n✅ Schémas enrichis avec imports générés dans app/schemas/")
