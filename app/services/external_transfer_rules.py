...
EXTERNAL_TRANSFER_STATUS_PARTIALLY_REPAID = "partially_repaid"
EXTERNAL_TRANSFER_STATUS_REPAID = "repaid"
...
EXTERNAL_TRANSFER_TO_TRANSACTION_STATUS: dict[str, str] = {
    ...
    EXTERNAL_TRANSFER_STATUS_FAILED: "failed",
    EXTERNAL_TRANSFER_STATUS_CANCELLED: "cancelled",
    EXTERNAL_TRANSFER_STATUS_PARTIALLY_REPAID: "succeeded",
    EXTERNAL_TRANSFER_STATUS_REPAID: "succeeded",
}
...
ALLOWED_EXTERNAL_TRANSFER_TRANSITIONS: dict[str, set[str]] = {
    ...
    EXTERNAL_TRANSFER_STATUS_REPAID: set(),
}
